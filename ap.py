...
def signup():
    if request.method == 'POST':
        ...
        if not username or not email or not password:
            return render_template('signup.html', alert_message="All fields are required!")
        ...
        try:
            ...
            return render_template('signup.html', alert_message="An error occurred. Please try again.")

    # Render the signup form if method is GET
